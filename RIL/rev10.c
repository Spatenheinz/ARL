...
int main(int ac, int* av)
{
  ...
  uint var_copyQ = 0;
  uint var_copyP = 0;
  uint var_inv_t_rev18x_ys = 0;
  uint var_inv_t_rev17x_ys = 0;
  uint var_inv_t_rev15xs_x_ys = 0;
  uint var_inv_t_rev14xs_x_ys = 0;
  uint var_inv_t_rev14x_xs = 0;
  uint var_inv_t_rev13x_xs = 0;
  uint var_x = 0;
  uint var_t5x_xs = 0;
  uint var_t4x_xs = 0;
  uint var_t2x_xs_ys = 0;
  uint var_t1x_xs_ys = 0;
  uint var_ys = 0;
  uint var_t13C2__ys = 0;
  ...
  void writeVars() {
    ...
    printf("var_copyQ = \%u\n",var_copyQ);
    printf("var_copyP = \%u\n",var_copyP);
    printf("var_inv_t_rev18x_ys = \%u\n",var_inv_t_rev18x_ys);
    printf("var_inv_t_rev17x_ys = \%u\n",var_inv_t_rev17x_ys);
    printf("var_inv_t_rev15xs_x_ys = \%u\n",var_inv_t_rev15xs_x_ys);
    printf("var_inv_t_rev14xs_x_ys = \%u\n",var_inv_t_rev14xs_x_ys);
    printf("var_inv_t_rev14x_xs = \%u\n",var_inv_t_rev14x_xs);
    printf("var_inv_t_rev13x_xs = \%u\n",var_inv_t_rev13x_xs);
    printf("var_x = \%u\n",var_x);
    printf("var_t5x_xs = \%u\n",var_t5x_xs);
    printf("var_t4x_xs = \%u\n",var_t4x_xs);
    printf("var_t2x_xs_ys = \%u\n",var_t2x_xs_ys);
    printf("var_t1x_xs_ys = \%u\n",var_t1x_xs_ys);
    printf("var_ys = \%u\n",var_ys);
    printf("var_t13C2__ys = \%u\n",var_t13C2__ys);
...
Label_inv_xs_C2_reverse7:
  ...
  if (count(1,0), var_inv_t_reverse6xs_C2_ != 0) goto Label_inv_5reverse8; else goto Label_split_88_27;
...
Label_inv_xs_C2_reverse5:
  ...
  if (count(1,0), (var_A & 3)) goto Label_C2__ysreverse12; else goto Label_split_98_7;
...
Label_split_98_7:
  ...
  Return_100_9:
  tmp = var_t12C2__ys;
  var_t12C2__ys = (var_consA);
  var_consA = (tmp);
  tmp = var_t13C2__ys;
  var_t13C2__ys = (var_consD);
  var_consD = (tmp);
  if (count(1,0), var_t12C2__ys != 2) goto Label_reverse15; else goto Label_split_103_16;

Label_split_103_16:
count(1, 0);
  var_t12C2__ys = (var_t12C2__ys - (2 + 0));
...
Label_reverse15:
  ...
  if (count(1,0), var_t12C2__ys != 0) goto Label_reverse13; else goto Label_split_106_16;
...
Label_split_106_16:
  tmp = var_ys;
  var_ys = (var_t13C2__ys);
  var_t13C2__ys = (tmp);
  if (count(1,0), var_t13C2__ys == 0) goto Label_reverse14; else goto Label_join_109_11;
...
Label_reverse13:
  ...
  if (count(1,0), var_t12C2__ys != 0) goto Label_inv_5reverse18; else goto Label_split_110_16;
...
Label_inv_5reverse18:
  if (count(1,0), !(var_t12C2__ys != 2)){
...
Label_rev_entry_1:
  if (count(1,0), (var_A & 3)) goto Label_x_xs_ysrev1; else goto Label_split_144_7;
...
Label_split_144_7:
  ...
  Return_146_13:
  tmp = var_t1x_xs_ys;
  var_t1x_xs_ys = (var_consA);
  var_consA = (tmp);
  tmp = var_t2x_xs_ys;
  var_t2x_xs_ys = (var_consD);
  var_consD = (tmp);
  if (count(1,0), (var_t1x_xs_ys & 3)) goto Label_x_xsrev4; else goto Label_split_149_15;

Label_split_149_15:
  tmp = var_t1x_xs_ys;
  var_t1x_xs_ys = (var_consP);
  var_consP = (tmp);
  count(2,0);
  ...
  Return_151_14:
  tmp = var_t4x_xs;
  var_t4x_xs = (var_consA);
  var_consA = (tmp);
  tmp = var_t5x_xs;
  var_t5x_xs = (var_consD);
  var_consD = (tmp);
  tmp = var_x;
  var_x = (var_t4x_xs);
  var_t4x_xs = (tmp);
  if (count(1,0), var_t4x_xs != 0) goto Label_rev5; else goto Label_split_155_13;

Label_split_155_13:
  tmp = var_xs;
  var_xs = (var_t5x_xs);
  var_t5x_xs = (tmp);
  if (count(1,0), var_t5x_xs == 0) goto Label_rev6; else goto Label_join_158_6;
...
Label_rev6:
  if (count(1,0), !(var_t1x_xs_ys == 0)){
    fprintf(stderr,"\nJoin failure at line 164\n");
  writeVars(); goto programEnd;
}
  goto Label_join_165_10;
...
Label_x_xsrev4:
  if (count(1,0), !((var_t1x_xs_ys & 3))){
    fprintf(stderr,"\nJoin failure at line 165\n");
  writeVars(); goto programEnd;
}
  if (count(1,0), var_t1x_xs_ys != 0) goto Label_rev2; else goto Label_split_166_16;
...
Label_split_166_16:
  tmp = var_ys;
  var_ys = (var_t2x_xs_ys);
  var_t2x_xs_ys = (tmp);
  if (count(1,0), var_t2x_xs_ys == 0) goto Label_rev3; else goto Label_join_169_6;
...
Label_rev2:
  ...
  if (count(1,0), (var_t1x_xs_ys & 3)) goto Label_inv_x_xsrev13; else goto Label_split_170_15;
...
Label_split_170_15:
  if (count(1,0), var_t1x_xs_ys == 0) goto Label_inv_x_xsrev15; else goto Label_split_171_16;
...
Label_split_171_16:
  ...
  goto Label__cons;
  Return_173_17:
  tmp = var_inv_t_rev13x_xs;
  var_inv_t_rev13x_xs = (var_consA);
  var_consA = (tmp);
  tmp = var_inv_t_rev14x_xs;
  var_inv_t_rev14x_xs = (var_consD);
  var_consD = (tmp);
  tmp = var_x;
  var_x = (var_inv_t_rev13x_xs);
  var_inv_t_rev13x_xs = (tmp);
  if (count(1,0), var_inv_t_rev13x_xs != 0) goto Label_inv_x_xsrev14; else goto Label_join_178_15;

Label_inv_x_xsrev15:
  if (count(1,0), !(var_inv_t_rev14x_xs == 0)){
    fprintf(stderr,"\nJoin failure at line 178\n");
  writeVars(); goto programEnd;
}
  tmp = var_xs;
  var_xs = (var_inv_t_rev14x_xs);
  var_inv_t_rev14x_xs = (tmp);
...
Label_inv_x_xsrev14:
  if (count(1,0), !(var_inv_t_rev13x_xs != 0)){
...
Label_rev_exit_2:
  ...
  if (count(1,0), (var_A & 3)) goto Label_inv_xs_x_ysrev14; else goto Label_split_202_7;
...
Label_split_202_7:
  if (count(1,0), var_A == 0) goto Label_inv_xs_x_ysrev16; else goto Label_split_203_8;
...
Label_split_203_8:
  ...
  goto Label__cons;
  Return_205_22:
  tmp = var_inv_t_rev14xs_x_ys;
  var_inv_t_rev14xs_x_ys = (var_consA);
  var_consA = (tmp);
  tmp = var_inv_t_rev15xs_x_ys;
  var_inv_t_rev15xs_x_ys = (var_consD);
  var_consD = (tmp);
  tmp = var_xs;
  var_xs = (var_inv_t_rev14xs_x_ys);
  var_inv_t_rev14xs_x_ys = (tmp);
  if (count(1,0), var_inv_t_rev14xs_x_ys != 0) goto Label_inv_xs_x_ysrev15; else goto Label_join_210_18;

Label_inv_xs_x_ysrev16:
  if (count(1,0), !(var_inv_t_rev15xs_x_ys == 0)){
    fprintf(stderr,"\nJoin failure at line 210\n");
  writeVars(); goto programEnd;
}
  if (count(1,0), (var_inv_t_rev15xs_x_ys & 3)) goto Label_inv_x_ysrev17; else goto Label_split_211_24;
...
Label_split_211_24:
  if (count(1,0), var_inv_t_rev15xs_x_ys == 0) goto Label_inv_x_ysrev19; else goto Label_split_212_25;

Label_split_212_25:
  tmp = var_inv_t_rev15xs_x_ys;
  var_inv_t_rev15xs_x_ys = (var_consP);
  var_consP = (tmp);
  count(2,0);
   stack[stackPointer++] = &&Return_214_23;
  goto Label__cons;
  Return_214_23:
  tmp = var_inv_t_rev17x_ys;
  var_inv_t_rev17x_ys = (var_consA);
  var_consA = (tmp);
  tmp = var_inv_t_rev18x_ys;
  var_inv_t_rev18x_ys = (var_consD);
  var_consD = (tmp);
  tmp = var_x;
  var_x = (var_inv_t_rev17x_ys);
  var_inv_t_rev17x_ys = (tmp);
  if (count(1,0), var_inv_t_rev17x_ys != 0) goto Label_inv_x_ysrev18; else goto Label_join_219_15;

Label_inv_x_ysrev19:
  if (count(1,0), !(var_inv_t_rev18x_ys == 0)){
    fprintf(stderr,"\nJoin failure at line 219\n");
  writeVars(); goto programEnd;
}
  tmp = var_ys;
  var_ys = (var_inv_t_rev18x_ys);
  var_inv_t_rev18x_ys = (tmp);
  goto Label_join_221_15;
...
Label_inv_x_ysrev18:
  if (count(1,0), !(var_inv_t_rev17x_ys != 0)){
...
Label_inv_x_ysrev17:
  if (count(1,0), !((var_inv_t_rev15xs_x_ys & 3))){
    fprintf(stderr,"\nJoin failure at line 227\n");
  writeVars(); goto programEnd;
}
  goto Label_join_228_18;
...
Label_inv_xs_x_ysrev15:
  if (count(1,0), !(var_inv_t_rev14xs_x_ys != 0)){
...
Label__join_91_20:
  if (count(1,0), var_inv_t_reverse6xs_C2_ != 2) goto Label__inv_5reverse8; else goto Label__join_90_15;
...
Label__reverse13:
  ...
  if (count(1,0), var_t12C2__ys != 0) goto Label__reverse15; else goto Label__join_105_11;
...
Label__inv_5reverse18:
  if (count(1,0), !(var_t12C2__ys != 0)){
    fprintf(stderr,"\nJoin failure at line 110\n");
  writeVars(); goto programEnd;
}
  if (count(1,0), var_t12C2__ys != 0) goto Label__reverse13; else goto Label__join_109_11;
...
Label__join_117_11:
  ...
  var_t12C2__ys = (var_consA);
  var_consA = (tmp);
  if (count(1,0), var_t12C2__ys != 2) goto Label__inv_5reverse18; else goto Label__join_112_16;

Label__join_118_17:
  if (count(1,0), var_A == 0) goto Label__reverse14; else goto Label__join_117_11;
...
Label__C2__ys_rev_xs_C2__reverse4:
  ...
  if (count(1,0), (var_A & 3)) goto Label__C2__ysreverse12; else goto Label__join_118_17;
...
Label__join_164_6:
  ...
  var_x = (var_t4x_xs);
  var_t4x_xs = (tmp);
  if (count(1,0), var_t4x_xs != 0) goto Label__rev5; else goto Label__join_158_6;

Label__join_165_10:
  if (count(1,0), var_t1x_xs_ys == 0) goto Label__rev6; else goto Label__join_164_6;
...
Label__rev2:
  ...
  if (count(1,0), (var_t1x_xs_ys & 3)) goto Label__x_xsrev4; else goto Label__join_165_10;
...
Label__inv_x_xsrev13:
  ...
  if (count(1,0), var_t1x_xs_ys != 0) goto Label__rev2; else goto Label__join_169_6;
...
Label__join_180_15:
  ...
  var_xs = (var_inv_t_rev14x_xs);
  var_inv_t_rev14x_xs = (tmp);
  if (count(1,0), var_inv_t_rev14x_xs == 0) goto Label__inv_x_xsrev15; else goto Label__join_178_15;
...
Label__join_186_15:
  ...
  var_x = (var_inv_t_rev13x_xs);
  var_inv_t_rev13x_xs = (tmp);
  if (count(1,0), var_inv_t_rev13x_xs != 0) goto Label__inv_x_xsrev14; else goto Label__join_180_15;
...
Label__join_191_6:
  ...
  var_t1x_xs_ys = (var_consA);
  var_consA = (tmp);
  if (count(1,0), (var_t1x_xs_ys & 3)) goto Label__inv_x_xsrev13; else goto Label__join_186_15;

Label__join_192_13:
  if (count(1,0), var_A == 0) goto Label__rev3; else goto Label__join_191_6;
...
Label__rev_entry_2:
  ...
  if (count(1,0), (var_A & 3)) goto Label__x_xs_ysrev1; else goto Label__join_192_13;
...
Label__inv_x_ysrev17:
  if (count(1,0), !((var_inv_t_rev15xs_x_ys & 3))){
    fprintf(stderr,"\nJoin failure at line 211\n");
  writeVars(); goto programEnd;
}
  if (count(1,0), var_inv_t_rev15xs_x_ys == 0) goto Label__inv_xs_x_ysrev16; else goto Label__join_210_18;
...
Label__inv_x_ysrev19:
  if (count(1,0), !(var_inv_t_rev15xs_x_ys == 0)){
    fprintf(stderr,"\nJoin failure at line 212\n");
  writeVars(); goto programEnd;
}
  goto Label__split_211_24;
...
Label__join_221_15:
  ...
  var_ys = (var_inv_t_rev18x_ys);
  var_inv_t_rev18x_ys = (tmp);
  if (count(1,0), var_inv_t_rev18x_ys == 0) goto Label__inv_x_ysrev19; else goto Label__join_219_15;
...
Label__join_227_15:
  ...
  var_x = (var_inv_t_rev17x_ys);
  var_inv_t_rev17x_ys = (tmp);
  if (count(1,0), var_inv_t_rev17x_ys != 0) goto Label__inv_x_ysrev18; else goto Label__join_221_15;

Label__join_228_18:
  if (count(1,0), (var_inv_t_rev15xs_x_ys & 3)) goto Label__inv_x_ysrev17; else goto Label__join_227_15;
...
Label__join_234_18:
  ...
  var_xs = (var_inv_t_rev14xs_x_ys);
  var_inv_t_rev14xs_x_ys = (tmp);
  if (count(1,0), var_inv_t_rev14xs_x_ys != 0) goto Label__inv_xs_x_ysrev15; else goto Label__join_228_18;

Label__rev_exit_1:
  if (count(1,0), (var_A & 3)) goto Label__inv_xs_x_ysrev14; else goto Label__join_234_18;
